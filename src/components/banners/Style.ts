...
.banner-card-inner{
    ...
    &::before {
        ...
        height: 100%;
        border-radius: 10px;
        background: rgba(0, 0, 0, 0.4); /* Màu sắc và độ mờ của overlay */
        z-index: 1; 
    }
    &.theme-2{
        h2{
...
`;
const CustomBannerCardWrap2 = Styled.div`
position: relative
margin-bottom:
@media only screen and (max-width: 1199px){
    margin-bottom: 50px !important;
